  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <button type="button" class="btn btn-secondary align-items-end">Se connecter</button>
      </div>
    </div>
  </div>
</nav>
...
<div class="card" style="width: 28rem;">
  ...
  <div class="card-body">
    <!-- <h1 class="card-title">SWEET DATE</h1> -->
    <p class="card-text">Il est temps de rencontré votre moitié.</p>
