...
if (!empty($_POST["genderSearch"])) {
  setcookie("cookieGenderSearch", $_POST["genderSearch"], time() + 3600 * 24, "/");
}
?>
...
<head>
  ...
  <style>
    @font-face {
      font-family: Omegle;
      src: url("/assets/fonts/omegle.ttf");
    }
    @font-face {
      font-family: Kiss Melody;
      src: url("/assets/fonts/KissMelody.ttf");
    }
    body{

    }
    h1.title {
      font-family: Kiss Melody !important;
      src: url("/assets/fonts/KissMelody.ttf");
    }
